...
class EventsFestivalsTab extends StatelessWidget {
  var _pageController = PageController();

  EventsFestivalsTab(this._pageController);
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                            "Mais ${snapshot.data.documents.length.toString()} eventos na cidade",
                            style: TextStyle(
